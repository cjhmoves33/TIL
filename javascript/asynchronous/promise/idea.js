...
// * 코드를 실행 시켜보면 new Promise의 콜백은 동기적으로 실행되는 것을 확인 할 수 있다.(console.log를 실행하고 resolve까지 실행한다.)
// * console.log(promise1)의 결과를 보면 이행 상태의 Promise객체를 찍고
...
// * then의 콜백은 비동기로 이뤄진다. 그치만 then의 호출은 동기적으로 이루어진다. console.log(promise2)가 대기상태의 promise2를 찍는 이유이다.
